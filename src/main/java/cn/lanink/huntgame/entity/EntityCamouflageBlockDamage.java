 ...
 * @author lt_name
 */
public class EntityCamouflageBlockDamage extends EntityHuman implements IEntityCamouflage {
    ...
    @Deprecated
    public EntityCamouflageBlockDamage(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
        this.close();
    }

    public EntityCamouflageBlockDamage(FullChunk chunk, CompoundTag nbt, Player master) {
        super(chunk, nbt);
        this.master = master;
