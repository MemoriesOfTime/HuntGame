...
public class Tools {
    ...
    public static void spawnFirework(Position position) {
        ...
        ex.putByteArray("FireworkColor",new byte[]{
                (byte) DyeColor.values()[BlockHunt.RANDOM.nextInt(ItemFirework.FireworkExplosion.ExplosionType.values().length)].getDyeData()
        });
        ex.putByteArray("FireworkFade",new byte[0]);
        ex.putBoolean("FireworkFlicker",BlockHunt.RANDOM.nextBoolean());
        ex.putBoolean("FireworkTrail",BlockHunt.RANDOM.nextBoolean());
        ex.putByte("FireworkType",ItemFirework.FireworkExplosion.ExplosionType.values()
                [BlockHunt.RANDOM.nextInt(ItemFirework.FireworkExplosion.ExplosionType.values().length)].ordinal());
